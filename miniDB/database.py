...
class Database:
        ...
        if self._has_index(table_name) and condition_column == self.tables[table_name].column_names[self.tables[table_name].pk_idx]:
            ...
            try:
                ...
                table = self.tables[table_name]._select_where_with_hash(
                    columns, bt, condition, distinct, order_by, desc, limit)  # if btree fails it is hash index
        else:
    ...
    # prosthetoume argument to column tou index
    ...
    def drop_index(self, index_name):
        ...
        if index_name in self.tables['meta_indexes'].column_by_name('index_name'):
            ...
            # extra prosthiki kata tin diarkeia tou index.
